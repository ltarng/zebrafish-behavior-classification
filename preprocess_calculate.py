...
def calculate_semifinished_result(folder_path, video_name, filter_name):
    ...
    # Add a new column, and set default values with 0
    ...
    temp_df0 = df['Fish0_interframe_movement_dist'].copy()
    temp_df1 = df['Fish1_interframe_movement_dist'].copy()
    # temp_df2 = df['Fish0_interframe_moving_direction'].copy()
    ...
    with IncrementalBar('Progress of Basic Caculation', max=len(df.index)) as bar:  # with a progress bar
    ...
    # df['Fish0_interframe_moving_direction'] = temp_df2.copy()
    # df["Fish1_interframe_moving_direction"] = temp_df3.copy()
...
def calculate_final_result(folder_path, video_name, filter_name):
    ...
    anno_df['movement_length_fish0'] = 0
    anno_df['movement_length_fish1'] = 0
    ...
    temp_movement_length_fish0_df = anno_df['movement_length_fish0'].copy()
    temp_movement_length_fish1_df = anno_df['movement_length_fish1'].copy()
    ...
    with IncrementalBar('Progress of Final Caculation', max=len(anno_df.index)) as bar:  # with a progress bar
    ...
    anno_df['movement_length_fish0'] = temp_movement_length_fish0_df.copy()
    anno_df['movement_length_fish1'] = temp_movement_length_fish1_df.copy()
    ...
    anno_df.to_csv(video_name + "_" + filter_name + "_preprocessed_result.csv", index = False)
