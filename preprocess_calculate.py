...
def calculate_main(folder_path, video_name, filter_name):
    ...
    # anno_df['Fish0_moving_direction_normalized'] = 0
    # anno_df["Fish1_moving_direction_normalized"] = 0
    ...
    # temp_normalized_direction_fish0_df = anno_df['Fish0_moving_direction_normalized'].copy()
    # temp_normalized_direction_fish1_df = anno_df["Fish1_moving_direction_normalized"].copy()
    ...
    # anno_df['Fish0_moving_direction_normalized'] = temp_normalized_direction_fish0_df.copy()
    # anno_df["Fish1_moving_direction_normalized"] = temp_normalized_direction_fish1_df.copy()
